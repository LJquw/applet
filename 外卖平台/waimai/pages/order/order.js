...
Page({
  ...
  onLoad: function (options) {
    ...
    console.log("店家id = ",options.tecid);
      //根据商家id获取商家信息    data.data.busid
      wx.request({
        url: httpUrl+'/businesss/queryBusInfoById', //仅为示例，并非真实的接口地址
        data: {
          id: options.id
        },
        header: {
        ...
        wx.getStorage({
          ...
          success (res) {
            ...
            wx.request({
              ...
              data: {
                token:res.data,
                foodname:that.data.proinfo.food.proname,
                ...
                foodid:that.data.proinfo.food.id,
                tecid:tecid
              },
